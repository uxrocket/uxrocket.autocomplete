    ...
    if (stripos($item['name'], $_GET['term']) !== false) {
        switch ($type) {
            ...
            case 'list':
                ...
                $itemList[]          = array('name' => $item['name'], 'id' => $item['id']);
                break;
            case 'image':
                $items['itemList'][] = array('value' => $item['value'], 'image' => $item['image'], 'name' => $item['name'], 'id' => $item['id']);
                $itemList[]          = array('value' => $item['value'], 'image' => $item['image'], 'name' => $item['name'], 'id' => $item['id']);
                break;
            case 'category':
                ...
                $itemList[]          = array('value' => $item['value'], 'category' => $item['category'], 'name' => $item['name'],
                                             'id'    => $item['id'], 'visiblename' => $item['category'] . ', ' . $item['name']);
                break;
            case 'tree':
                $items['itemList'][] = array('value' => $item['value'], 'category' => $item['category'], 'image' => $item['image'], 'name' => $item['name'], 'id' => $item['id']);
                $itemList[]          = array('value' => $item['value'], 'category' => $item['category'], 'image' => $item['image'], 'name' => $item['name'], 'id' => $item['id']);
                break;
        }
    }
}
