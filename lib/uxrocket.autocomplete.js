...
;(function($){
	var ux, // local shorthand
        ...
        templates = {
            ...
            category: {
                wrap: '<ul></ul>',
                head: '<li class="uxitd-autocomplete-category ui-autocomplete-category">' +
	...
	var setLayout = function($el){
        ...
        if($el.parent().is('.uxitd-plugin-wrap')){
            ...
            $el.wrap('<span class="uxitd-plugin-wrap uxitd-autocomplete-holder' + columns + ' group"></span>');
        }

		$el.after('<i class="icon-search"></i>');
	};

    var setSource = function(opts){
        var fdata = null,
    ...
    var setTemplate = function($el, opts){
        var autocomplete = $el.data("uiAutocomplete"),
            template = {};
	...
	// jquery bindings
		...
		return this.each(function(){
			...
			if($el.hasClass('uxitd-autocomplete-ready')){
				return;
			}
