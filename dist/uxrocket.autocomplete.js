...
(function($) {
    ...
    var bindUIActions = function($el) {
        ...
        if(typeof _opts.props !== 'undefined' && _opts.props != '' && typeof $el.attr('readonly') === 'undefined') {
        ...
        if(_opts.onButtonClick !== false && typeof $el.attr('readonly') === 'undefined') {
            $el.next('.' + ns.icon).on(events.click, function() {
                var inputElem = $(this).siblings().find("input");
                if(!(inputElem.hasClass('readOnly') || inputElem.attr('readonly'))) {
